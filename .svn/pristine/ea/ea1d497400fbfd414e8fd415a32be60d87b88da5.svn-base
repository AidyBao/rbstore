...
class ZXUIViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if self.isKind(of: ZXHomepageViewController.self) ||
            self.isKind(of: ZXShoppingCartViewController.self) ||
            self.isKind(of: ZXPersonalCenterViewController.self) ||
            self.isKind(of: ZXCategoryRootViewController.self) {
