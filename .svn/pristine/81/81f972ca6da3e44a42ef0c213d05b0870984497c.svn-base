...
class ZXRefreshHeader: MJRefreshGifHeader {
    override func prepare() {
        ...
        for i in 1..<15 {
            let img = UIImage(named: String(format: "rbrefresh%d", i))
            if let img = img {
        ...
        self.setImages(refreshingImages, duration: 1.5, for: .pulling)
        self.setImages(refreshingImages, duration: 1.5, for: .refreshing)
    }
}
