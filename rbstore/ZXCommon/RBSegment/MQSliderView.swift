...
class MQSliderView: UIView, UIScrollViewDelegate {
    ...
    /// 间歇高度
    public var spaceHeight: CGFloat = 0
    ...
    private func maketopView() {
        ...
        topView.frame = CGRect.init(x: 0, y: 0, width: Int(self.width), height: topViewHeight)
    ...
    private func addContentView() {
        ...
        scrollView.backgroundColor = lineColor
