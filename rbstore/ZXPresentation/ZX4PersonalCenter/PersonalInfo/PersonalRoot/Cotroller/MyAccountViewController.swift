...
extension MyAccountViewController {
    ...
    func setDefault() {
        self.userHeadImgView.kf.setImage(with: URL.init(string: ZXUser.user.headPortraitFilesStr), placeholder: UIImage.Default.headerIcon, options: nil, progressBlock: nil, completionHandler: nil)
        
        self.nickNameDetailLB.text = ZXUser.user.nameStr
